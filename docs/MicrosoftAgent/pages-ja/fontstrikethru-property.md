---
layout: Conceptual
title: FontStrikeThru プロパティ - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/ja-jp/windows/win32/lwef/fontstrikethru-property
schema: Conceptual
adobe-target: true
author: GrantMeStrength
breadcrumb_path: /windows/desktop/breadcrumb/toc.json
depot_name: MSDN.win32
description: FontStrikeThru プロパティ
...
loc_file_id: Github-175691945.live.MSDN.win32.lwef/fontstrikethru-property.md
...
# FontStrikeThru プロパティ - Win32 apps | Microsoft Learn
...
- **構文の**
    - エージェント \*\* です。characters ("***CharacterID***")。Balloon.FontStrikeThru\*\*

| 価値 | 形容 |
| --- | --- |
| **True** | 吹き出しフォントは取り消し線効果を使用します。 |
| false **の** | 吹き出しフォントでは取り消し線効果は使用されません。 |
