---
layout: Conceptual
title: Width プロパティ (Characters オブジェクト) - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/ja-jp/windows/win32/lwef/width-property-co
schema: Conceptual
adobe-target: true
author: GrantMeStrength
breadcrumb_path: /windows/desktop/breadcrumb/toc.json
depot_name: MSDN.win32
description: 指定した文字のフレームの幅を取得または設定する Characters オブジェクトの Width プロパティについて説明します。
...
loc_file_id: Github-175691945.live.MSDN.win32.lwef/width-property-co.md
...
# Width プロパティ (Characters オブジェクト) - Win32 apps | Microsoft Learn

[Microsoft エージェントは Windows 7 の時点で非推奨となり、以降のバージョンの Windows では使用できない可能性があります。]

- **説明**
    - 指定した文字のフレームの幅を設定または返します。
- **構文の**
    - エージェント \*\* です。characters ("***CharacterID***")。Width\*\* [= *value*]
...
[**Width**](width-property) プロパティは常にピクセル単位で表されます。 このプロパティの設定は、文字のすべてのクライアントに適用されます。
