...
canonicalUrl: https://learn.microsoft.com/ja-jp/windows/win32/lwef/iagent--register
schema: Conceptual
adobe-target: true
...
loc_file_id: Github-175691945.live.MSDN.win32.lwef/iagent--register.md
...
クライアント アプリケーションの通知シンクを登録します。

- 操作が成功したことを示すS\_OKを返します。

- *IUnknown*
    - 通知シンク インターフェイス [**IUnknown**](https://www.bing.com/search?q=**IUnknown**) のアドレス。
- pdwSinkID*を * する
    - 通知シンク ID のアドレス (通知シンクの登録解除に使用)。

Microsoft エージェント サーバーからイベントを受信するには、通知シンク (通知シンクまたはイベント シンクとも呼ばれます) を登録する必要があります。