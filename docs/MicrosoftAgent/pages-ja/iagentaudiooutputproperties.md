...
canonicalUrl: https://learn.microsoft.com/ja-jp/windows/win32/lwef/iagentaudiooutputproperties
schema: Conceptual
adobe-target: true
...
loc_file_id: Github-175691945.live.MSDN.win32.lwef/iagentaudiooutputproperties.md
...
IAgentAudioOutputProperties は、Microsoft エージェント サーバーによって管理されるオーディオ出力プロパティへのアクセスを提供します。 これらの関数は、IAgentAudioOutputProperties からも使用できます。 プロパティは読み取り専用ですが、ユーザーは Microsoft Agent プロパティ シートでそれらを変更できます。

Vtable Order **のメソッドを** する

| IAgentAudioOutputProperties メソッド | 形容 |
| --- | --- |
| GetEnabled**[の](iagentaudiooutputproperties--getenabled)** | オーディオ出力が有効かどうかを返します。 |
| [**GetUsingSoundEffects**](iagentaudiooutputproperties--getusingsoundeffects) | 効果音出力が有効かどうかを返します。 |