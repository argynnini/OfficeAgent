...
canonicalUrl: https://learn.microsoft.com/ja-jp/windows/win32/lwef/iagentballoon--getfontcharset
schema: Conceptual
adobe-target: true
...
loc_file_id: Github-175691945.live.MSDN.win32.lwef/iagentballoon--getfontcharset.md
...
単語吹き出しに表示されるフォントの文字セットを示します。

- 操作が成功したことを示すS\_OKを返します。

- psFontCharSet*の *
    - フォントの文字セットを受け取る値のアドレス。 値の一般的な設定を次に示します。
...
文字のワード バルーンで使用される既定の文字セットは、Microsoft エージェント文字エディターで定義されます。 IAgentBalloon::SetFontCharSet使用して変更できます。 ただし、ユーザーは Microsoft Agent プロパティ シートを使用して、すべての文字の文字セット設定をオーバーライドできます。