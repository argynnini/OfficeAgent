...
canonicalUrl: https://learn.microsoft.com/ja-jp/windows/win32/lwef/iagentballoon--setvisible
schema: Conceptual
adobe-target: true
...
loc_file_id: Github-175691945.live.MSDN.win32.lwef/iagentballoon--setvisible.md
...
吹き出しの [**Visible**](visible-property) プロパティを設定します。

- 操作が成功したことを示すS\_OKを返します。

- *bVisible*
    - Visible プロパティの設定。 **True** の値を指定すると、吹き出しという単語が表示されます。false の値  非表示にします。