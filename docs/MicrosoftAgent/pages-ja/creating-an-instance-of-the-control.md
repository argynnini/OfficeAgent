---
layout: Conceptual
title: コントロールのインスタンスの作成 - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/ja-jp/windows/win32/lwef/creating-an-instance-of-the-control
schema: Conceptual
adobe-target: true
author: GrantMeStrength
breadcrumb_path: /windows/desktop/breadcrumb/toc.json
depot_name: MSDN.win32
description: コントロールのインスタンスの作成
...
loc_file_id: Github-175691945.live.MSDN.win32.lwef/creating-an-instance-of-the-control.md
...
# コントロールのインスタンスの作成 - Win32 apps | Microsoft Learn

[Microsoft エージェントは Windows 7 の時点で非推奨となり、以降のバージョンの Windows では使用できない可能性があります。]

Microsoft エージェントのコントロールにアクセスするには、まずコントロールのインスタンスを作成する必要があります。 これを行う最も簡単な方法は、フォームにコントロールのインスタンスを配置することです。 フォームに追加する前に、ツールボックスにコントロールを追加する必要がある場合があります。 プログラミング言語によっては、実行時にコントロールを作成することもできます。