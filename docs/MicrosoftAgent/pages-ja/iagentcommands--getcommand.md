...
canonicalUrl: https://learn.microsoft.com/ja-jp/windows/win32/lwef/iagentcommands--getcommand
schema: Conceptual
adobe-target: true
...
loc_file_id: Github-175691945.live.MSDN.win32.lwef/iagentcommands--getcommand.md
...
[**Commands**](/ja-jp/windows/desktop/lwef/the-commands-collection-object) コレクションから [**Command**](/ja-jp/windows/desktop/lwef/the-command-object) オブジェクトを取得します。

- 操作が成功したことを示すS\_OKを返します。

- dwCommandID*の *
    - [**Commands**](/ja-jp/windows/desktop/lwef/the-commands-collection-object) コレクション内の [**Command**](/ja-jp/windows/desktop/lwef/the-command-object) オブジェクトの ID。
- *IUnknown*
    - [**Command**](/ja-jp/windows/desktop/lwef/the-command-object) オブジェクトの [**IUnknown**](/ja-jp/windows/desktop/api/unknwn/nn-unknwn-iunknown) インターフェイスのアドレス。