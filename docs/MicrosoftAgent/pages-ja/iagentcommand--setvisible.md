...
canonicalUrl: https://learn.microsoft.com/ja-jp/windows/win32/lwef/iagentcommand--setvisible
schema: Conceptual
adobe-target: true
...
loc_file_id: Github-175691945.live.MSDN.win32.lwef/iagentcommand--setvisible.md
...
[**コマンド**](/ja-jp/windows/desktop/lwef/the-command-object)の [**Visible**](visible-property) プロパティの値を設定します。

- 操作が成功したことを示すS\_OKを返します。

- *bVisible*
    - [**コマンド**](/ja-jp/windows/desktop/lwef/the-command-object)の [**Visible**](visible-property) プロパティを決定するブール値。 **True** は、**コマンドの**を示します。**False** は非表示にします。

[**コマンド**](/ja-jp/windows/desktop/lwef/the-command-object) では、その [**Visible**](visible-property) プロパティが true  に設定され、その [**Caption**](caption-property) プロパティが文字のポップアップ メニューに表示されるように設定されている必要があります。