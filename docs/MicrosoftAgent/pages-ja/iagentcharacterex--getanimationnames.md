...
canonicalUrl: https://learn.microsoft.com/ja-jp/windows/win32/lwef/iagentcharacterex--getanimationnames
schema: Conceptual
adobe-target: true
...
loc_file_id: Github-175691945.live.MSDN.win32.lwef/iagentcharacterex--getanimationnames.md
...
- *IUnknown*
    - キャラクターのアニメーション コレクションの [**IUnknown**](/ja-jp/windows/win32/api/unknwn/nn-unknwn-iunknown) インターフェイスのアドレス。
...
ACF 文字の場合、コレクションは、[**Get**](https://www.bing.com/search?q=**Get**) メソッドを使用して取得されたアニメーションに追加して、その文字に対して定義されているすべてのアニメーションを返します。