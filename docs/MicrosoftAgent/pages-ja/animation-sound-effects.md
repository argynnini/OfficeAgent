---
layout: Conceptual
title: アニメーション効果音 - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/ja-jp/windows/win32/lwef/animation-sound-effects
schema: Conceptual
adobe-target: true
author: GrantMeStrength
breadcrumb_path: /windows/desktop/breadcrumb/toc.json
depot_name: MSDN.win32
description: アニメーション効果音
...
loc_file_id: Github-175691945.live.MSDN.win32.lwef/animation-sound-effects.md
...
# アニメーション効果音 - Win32 apps | Microsoft Learn

[Microsoft エージェントは Windows 7 の時点で非推奨となり、以降のバージョンの Windows では使用できない可能性があります。]

また、Microsoft エージェントを使用すると、キャラクターのアニメーションの一部としてサウンド エフェクトを含めることもできます。 Microsoft エージェント文字エディターを使用して、標準の Windows サウンド (.特定のフレームでトリガーする WAV) ファイル。 Microsoft Agent ではサウンド エフェクトと音声出力が混在しないため、音声出力はサウンド エフェクトが完了するまで開始されません。 そのため、キャラクターのアニメーションの一部として、長いサウンドエフェクトやループ効果を避けてください。