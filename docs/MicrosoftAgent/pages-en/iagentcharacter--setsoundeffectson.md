...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcharacter--setsoundeffectson
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcharacter--setsoundeffectson.md
cmProducts:
