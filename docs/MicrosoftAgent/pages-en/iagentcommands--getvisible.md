...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcommands--getvisible
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcommands--getvisible.md
cmProducts:
...
Retrieves the value of the [**Visible**](visible-property) property for a [**Commands**](/en-us/windows/desktop/lwef/the-commands-collection-object) collection.

- Returns S\_OK to indicate the operation was successful.

- *pbVisible*
    - The address of a variable that receives the value of the [**Visible**](visible-property) property for a [**Commands**](/en-us/windows/desktop/lwef/the-commands-collection-object) collection.