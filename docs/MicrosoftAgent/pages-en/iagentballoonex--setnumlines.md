...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentballoonex--setnumlines
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentballoonex--setnumlines.md
cmProducts:
...
The minimum setting is 1 and maximum is 128. If the text specified in the [**Speak**](speak-method) or [**Think**](think-method) method exceeds the size of the current balloon, Agent automatically scrolls the text in the balloon.
