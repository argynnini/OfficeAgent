...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcharacterex--getoriginalsize
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcharacterex--getoriginalsize.md
cmProducts:
