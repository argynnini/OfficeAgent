...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcommandex--gethelpcontextid
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcommandex--gethelpcontextid.md
cmProducts:
...
Retrieves the [**HelpContextID**](helpcontextid-property-com) for a [**Command**](/en-us/windows/desktop/lwef/the-command-object) object.

- Returns S\_OK to indicate the operation was successful.

- *pulID*
    - Address of a variable that receives the context number of the help topic associated with the [**Command**](/en-us/windows/desktop/lwef/the-command-object) object.

If you've created a Windows Help file for your application and set your character's [**HelpFile**](helpfile-property) property to this file, Microsoft Agent automatically calls Help when [**HelpModeOn**](helpmodeon-property) is set to **True** and the user selects the command. If there is a context number in the [**HelpContextID**](helpcontextid-property-com), Agent calls Help and searches for the topic identified by the current context number. The current context number is the value of **HelpContextID** for the command.
