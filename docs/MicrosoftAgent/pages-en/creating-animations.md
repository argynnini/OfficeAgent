---
layout: Conceptual
title: Creating Animations - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/creating-animations
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/creating-animations.md
cmProducts:
...
# Creating Animations - Win32 apps | Microsoft Learn
...
The Editor does not support creating additional states because states only apply to situations where the server must play an animation automatically on behalf of the client application. Thus, there is no benefit in defining your own state. If need be, you can play any animation explicitly using the [**Play**](play-method) method.
