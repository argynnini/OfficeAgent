---
layout: Conceptual
title: Ctx Tag - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/ctx-tag
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/ctx-tag.md
cmProducts:
...
# Ctx Tag - Win32 apps | Microsoft Learn
...
| Part | Description |
| --- | --- |
| *string* | A string specifying the context of the text that follows, which determines how symbols or abbreviations are spoken.**"Address"** Addresses and/or phone numbers.**"E-mail"** Electronic mail.**"Unknown"** (Default) Context is unknown. |
