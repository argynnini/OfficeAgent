---
layout: Conceptual
title: Caption Property (Command Object) - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/caption-property
...
description: Learn about the Caption property of the Command object. Microsoft Agent is deprecated as of Windows 7.
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/caption-property.md
cmProducts:
...
# Caption Property (Command Object) - Win32 apps | Microsoft Learn

[Microsoft Agent is deprecated as of Windows 7, and may be unavailable in subsequent versions of Windows.]

- **Description**
    - Determines the text displayed for a [**Command**](/en-us/windows/desktop/lwef/the-command-object) in the specified character's pop-up menu.
- **Syntax**
