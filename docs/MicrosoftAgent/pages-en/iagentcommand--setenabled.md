...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcommand--setenabled
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcommand--setenabled.md
cmProducts:
...
Sets the [**Enabled**](enabled-property) property for a [**Command**](/en-us/windows/desktop/lwef/the-command-object).

- Returns S\_OK to indicate the operation was successful.

- *bEnabled*
    - A Boolean value that sets the value of the [**Enabled**](enabled-property) setting of a [**Command**](/en-us/windows/desktop/lwef/the-command-object). **True** enables the **Command**; **False** disables it. A disabled **Command** cannot be selected.

A [**Command**](/en-us/windows/desktop/lwef/the-command-object) must have its [**Enabled**](enabled-property) property set to **True** to be selectable. It also must have its [**Caption**](caption-property) property set and its [**Visible**](visible-property) property set to **True** to appear in the character's pop-up menu. To make the **Command** appear in the **Voice Commands Window**, you must set its [**Voice**](voice-property)property.