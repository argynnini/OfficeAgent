...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcommandsex--getvoicecaption
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcommandsex--getvoicecaption.md
cmProducts:
...
Retrieves the [**VoiceCaption**](voicecaption-property) for a [**Command**](/en-us/windows/desktop/lwef/the-command-object) object.
...
The text returned is that set for your [**Command**](/en-us/windows/desktop/lwef/the-command-object) object and appears in the Voice Commands window when your client application is input-active.
