---
layout: Conceptual
title: DragStart Event - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/dragstart-event
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/dragstart-event.md
cmProducts:
...
# DragStart Event - Win32 apps | Microsoft Learn
...
[**DragComplete event**](dragcomplete-event)