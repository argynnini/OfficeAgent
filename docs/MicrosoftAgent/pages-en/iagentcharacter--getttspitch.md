...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcharacter--getttspitch
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcharacter--getttspitch.md
cmProducts:
