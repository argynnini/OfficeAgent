...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcommandsex--insertex
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcommandsex--insertex.md
cmProducts:
...
[**IAgentCommandsEx::InsertEx**](https://www.bing.com/search?q=**IAgentCommandsEx::InsertEx**) extends [**IAgentCommands::Insert**](iagentcommands--insert) by including the [**HelpContextID**](helpcontextid-property) property. You can also set the property using [**IAgentCommandsEx::SetHelpContextID**](iagentcommandsex--sethelpcontextid)