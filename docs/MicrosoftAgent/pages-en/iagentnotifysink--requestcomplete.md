...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentnotifysink--requestcomplete
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentnotifysink--requestcomplete.md
cmProducts:
