...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentpropertysheet--getvisible
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentpropertysheet--getvisible.md
cmProducts:
