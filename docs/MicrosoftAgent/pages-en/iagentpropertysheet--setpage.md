...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentpropertysheet--setpage
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentpropertysheet--setpage.md
cmProducts:
