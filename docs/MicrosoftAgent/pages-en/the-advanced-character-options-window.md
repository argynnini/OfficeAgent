---
layout: Conceptual
title: Advanced Character Options Window (Microsoft Agent User Interface) - Win32 apps | Microsoft Learn
...
# Advanced Character Options Window (Microsoft Agent User Interface) - Win32 apps | Microsoft Learn
...
- [The Output Page](the-output-page)
- [The Speech Input Page](the-speech-input-page)
- [The Copyright Page](the-copyright-page)