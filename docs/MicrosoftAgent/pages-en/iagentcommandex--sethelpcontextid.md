...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcommandex--sethelpcontextid
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcommandex--sethelpcontextid.md
cmProducts:
...
Sets the [**HelpContextID**](helpcontextid-property-com) for a [**Command**](/en-us/windows/desktop/lwef/the-command-object) object.
