---
layout: Conceptual
title: Show Event - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/show-event
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/show-event.md
cmProducts:
...
# Show Event - Win32 apps | Microsoft Learn
...
[**Hide event**](hide-event), [**VisibilityCause**](visibilitycause-property)