---
layout: FAQ
title: Programming Scripting FAQ - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/programming-scripting-faq
summary: >
...
locale: en-us
document_id: cb7f97a4-f05e-718d-a900-f1f7bb618b50
document_version_independent_id: cef93cb4-bdd0-3927-d15e-33638885eabc
updated_at: 2022-02-15T19:29:00.0000000Z
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/programming-scripting-faq.yml
cmProducts:
...
# Programming Scripting FAQ - Win32 apps | Microsoft Learn
...
Most of the events, methods, and properties supported by the Microsoft Agent control are exposed only at run time. Consult [Programming the Microsoft Agent Control](programming-the-microsoft-agent-control) for further information.
...
Microsoft Agent does not support all the tags specified in the Microsoft Speech API. In addition, support for some parameters may depend on the text-to-speech engine installed. For further information, see [Microsoft Agent Speech Output Tags](microsoft-agent-speech-output-tags).
...
Yes, provided that the engine supports the Microsoft Speech API (SAPI) 4.0 interfaces required by Microsoft Agent. Check with the engine supplier. For complete details on the SAPI interfaces required by Microsoft Agent, see [Speech Engine Support Requirements](speech-engine-support-requirements).
...
When you play an animation, the animation services continue to display its last frame until another animation is called. Therefore, you should play another animation after calling [**MoveTo**](moveto-method). If you defined a **Return** animation for the **Moving** state animation, the server will play it first.
