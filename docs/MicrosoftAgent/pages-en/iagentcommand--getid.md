...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcommand--getid
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcommand--getid.md
cmProducts:
...
Retrieves the ID for a [**Command**](/en-us/windows/desktop/lwef/the-command-object).

- Returns S\_OK to indicate the operation was successful.

- *pdwID*
    - The address of a variable that receives the ID of a [**Command**](/en-us/windows/desktop/lwef/the-command-object).