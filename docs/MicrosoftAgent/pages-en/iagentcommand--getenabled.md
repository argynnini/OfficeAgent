...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcommand--getenabled
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcommand--getenabled.md
cmProducts:
...
Retrieves the value of the [**Enabled**](enabled-property) property for a [**Command**](/en-us/windows/desktop/lwef/the-command-object).

- Returns S\_OK to indicate the operation was successful.

- *pbEnabled*
    - The address of a variable that receives **True** if the [**Command**](/en-us/windows/desktop/lwef/the-command-object) is enabled, or **False** if it is disabled. A disabled **Command** cannot be selected.