...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcharacter--hasotherclients
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcharacter--hasotherclients.md
cmProducts:
