...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcommandwindow--setvisible
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcommandwindow--setvisible.md
cmProducts:
...
Set the [**Visible**](visible-property) property for the Voice Commands Window.

- Returns S\_OK to indicate the operation was successful.

- *bVisible*
    - [**Visible**](visible-property) property setting. A value of **True** displays the Voice Commands Window; **False** hides it.
