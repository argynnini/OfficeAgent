...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentnotifysinkex--defaultcharacterchange
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentnotifysinkex--defaultcharacterchange.md
cmProducts:
