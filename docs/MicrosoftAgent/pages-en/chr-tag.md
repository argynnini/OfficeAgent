---
layout: Conceptual
title: Chr Tag - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/chr-tag
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/chr-tag.md
cmProducts:
...
# Chr Tag - Win32 apps | Microsoft Learn
...
| Part | Description |
| --- | --- |
| *string* | A string specifying the character of the voice.**"Normal"** (Default) A normal tone of voice.**"Monotone"** A monotone voice.**"Whisper"** A whispered voice. |
