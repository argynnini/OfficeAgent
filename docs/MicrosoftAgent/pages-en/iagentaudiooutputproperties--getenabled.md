...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentaudiooutputproperties--getenabled
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentaudiooutputproperties--getenabled.md
cmProducts:
