---
layout: Conceptual
title: Confidence Property - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/confidence-property
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/confidence-property.md
cmProducts:
...
# Confidence Property - Win32 apps | Microsoft Learn
...
| Part | Description |
| --- | --- |
| *Number* | A numeric expression that evaluates to a Long integer that identifies confidence value for the [**Command**](/en-us/windows/desktop/lwef/the-command-object). |

## Remarks

If the returned confidence value of the best match (UserInput.Confidence) does not exceed value you set for the **Confidence** property, the text supplied in [**ConfidenceText**](confidencetext-property) is displayed in the Listening Tip.