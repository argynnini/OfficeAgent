---
layout: Conceptual
title: MoveCause Property - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/movecause-property
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/movecause-property.md
cmProducts:
...
# MoveCause Property - Win32 apps | Microsoft Learn
...
You can use this property to determine what caused the character to move, when more than one application is sharing (has loaded) the same character. These values are the same as those returned by the [**Move**](move-event) event.