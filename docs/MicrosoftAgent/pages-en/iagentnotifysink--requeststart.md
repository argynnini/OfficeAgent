...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentnotifysink--requeststart
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentnotifysink--requeststart.md
cmProducts:
