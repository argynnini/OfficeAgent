...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentcharacterex--sethelpfilename
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentcharacterex--sethelpfilename.md
cmProducts:
