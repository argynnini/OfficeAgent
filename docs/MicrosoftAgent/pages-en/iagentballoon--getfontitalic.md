...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentballoon--getfontitalic
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentballoon--getfontitalic.md
cmProducts:
