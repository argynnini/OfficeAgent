---
layout: Conceptual
title: Creating a Notification Sink - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/creating-a-notification-sink
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/creating-a-notification-sink.md
cmProducts:
...
# Creating a Notification Sink - Win32 apps | Microsoft Learn

[Microsoft Agent is deprecated as of Windows 7, and may be unavailable in subsequent versions of Windows.]

To be notified of events by Microsoft Agent, you must implement either the [**IAgentNotifySink**](events)or the [**IAgentNotifySinkEx**](iagentnotifysinkex) interface, and create and register an object of that type following COM conventions:
