...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentpropertysheet--getposition
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentpropertysheet--getposition.md
cmProducts:
