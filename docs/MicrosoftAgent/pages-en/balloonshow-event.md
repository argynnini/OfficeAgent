---
layout: Conceptual
title: BalloonShow Event - Win32 apps | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/balloonshow-event
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/balloonshow-event.md
cmProducts:
...
# BalloonShow Event - Win32 apps | Microsoft Learn
...
[**BalloonHide event**](balloonhide-event)