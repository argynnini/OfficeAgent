...
canonicalUrl: https://learn.microsoft.com/en-us/windows/win32/lwef/iagentspeechinputproperties--getlisteningtip
...
monikers: []
item_type: Content
source_path: desktop-src/lwef/iagentspeechinputproperties--getlisteningtip.md
cmProducts:
...
If [**GetEnabled**](iagentspeechinputproperties--getenabled) returns **False**, querying any other speech input properties returns an error.